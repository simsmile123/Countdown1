...
addNewBook("The Scarlett Letter", "Nathaniel Hawthorne")
//(2)
console.log("hi")
const removeBook = (titleID) => {
    const indexToRemove = bookList.findIndex(book => book.title === titleID);
    if (indexToRemove !== -1) { //meaning we found an index to remove
...
//(3)
const listAll = (titles_or_authors) => {
